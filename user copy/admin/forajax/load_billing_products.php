...
if(isset($_SESSION['cart'])){
  $max= sizeof($_SESSION['cart']) ;//check this 
}
for($i=0; $i<$max; $i++){
  ...
  if(isset($_SESSION['cart'][$i])){
    ...
    if($company_name_session!=""){
       ...
       <td><input type= "text" id="tt<?php echo $i ?>" value="<?php echo $qty * $price_session ?> "><i class="fa fa-refresh" style="font-size:24px" onclick="edit_qty(document.getElementbyId('tt<?php echo $i ?>').value,<?php  echo '$company_name_session' ?>,<?php echo '$product_name_session' ?>, <?php echo 'unit_session' ?>, <?php echo '$packing_size_session' ?>,<?php echo '$qty_session' ?>,<?php echo '$price_session' ?>)" ></i></i><!--fa fa icon--></td>
