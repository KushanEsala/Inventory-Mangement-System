                ...
                <div class="span12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>5</td>
                            <td>50</td>
                            <td style="color: green" a href="">Edit</td>
                            <td style="color:red"><a href="forajax/delete_in_session.php">Delete</a></td>
                        </tr>
                    </table>

                    <h4>
                        <div style="float: right"><span style="float:left;">Total:RS</span><span style="float: left">525</span></div>
                    </h4>
