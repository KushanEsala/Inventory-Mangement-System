...
<div id="loginbox">
    ...
    <div class="control-group normal_text"><h2>Inventory management system</h2></div>
        <div class="control-group normal_text"><h3>UserLogin Page</h3></div>
        ...
        <center><a href="../admin/index.php" style="color:white">Admin login</a></center>
    </form>
    <?php
