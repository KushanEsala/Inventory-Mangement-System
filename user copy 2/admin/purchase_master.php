...
if(isset($_POST["submit1"])){
  ...
  $count=0;
  $res=mysqli_query($link,"select * from stock_master where product_company='[company_name]' && product_name='[product_name]' && product_unit='[unit_name]'");
  ...
  if($count==0){
    ...
    mysqli_query($link,"update stock_master set product_qty=product_qty+$_POST[qty] where product_company='$_POST[company_name]' && product_name='$_POST[product_name]' && product_unit='[unit_name]'")or die(mysqli_error($link));
